...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/number-float64-base-to-words/tags). For example,

```javascript
toWords = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-to-words@v0.1.0-umd/browser.js' )
```
